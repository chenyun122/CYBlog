...
## 前言  
 [Flutter](https://flutter.dev/) 作为谷歌推出的跨平台UI开发工具包，为用户创建本地编译的移动、Web和桌面应用提供了统一的代码库。它有快速热重载能力来提高开发效率，用户界面富有表现力和灵活性，以及媲美原生应用的执行性能(60帧)，这些特点让它对多端开发者来说很有吸引力。笔者已肤浅地认为它是超越 Reative Native 的存在😄。  
